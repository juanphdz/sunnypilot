...
# EU guidelines - reverted fully to stock. Even the smaller of our two bumps (6.0/3.5) still
# produced lateral ping-ponging (25-50mph) and a rough unwind exiting turns, so backing all the
# way out to isolate whether these two constants are the actual cause.
